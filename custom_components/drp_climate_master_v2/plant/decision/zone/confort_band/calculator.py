...
#             indoor_zone = indoor_zones[name]

#             indoor_rh = indoor_zone.humidity.value
#             indoor_t_op = indoor_zone.t_op.value if indoor_zone.t_op else None

#             if indoor_rh is None or indoor_t_op is None:
#                 return None        
...
#             area_confort_band = self.compute_single(
#                 room=name,
#                 season=OperativeSeason.from_value(season),
...
#         if season_state and vmc_air_speed is not None:

#             for area in runtime_config.climate.areas:
...
#             log_warning(_LOGGER, "vmc_speed=%s", vmc_air_speed)
